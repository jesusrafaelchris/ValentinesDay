...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/MapboxAccounts/MapboxAccounts.xcframework" "" "true" "ios-arm64_x86_64-maccatalyst/MapboxAccounts.framework" "ios-arm64_armv7/MapboxAccounts.framework" "ios-arm64_i386_x86_64-simulator/MapboxAccounts.framework"
  install_xcframework "${PODS_ROOT}/MapboxCommon/MapboxCommon.xcframework" "" "true" "ios-arm64_armv7/MapboxCommon.framework" "ios-x86_64-maccatalyst/MapboxCommon.framework" "ios-arm64_i386_x86_64-simulator/MapboxCommon.framework"
  install_xcframework "${PODS_ROOT}/MapboxNavigationNative/MapboxNavigationNative.xcframework" "" "true" "ios-arm64_armv7/MapboxNavigationNative.framework" "ios-arm64_i386_x86_64-simulator/MapboxNavigationNative.framework"
fi
